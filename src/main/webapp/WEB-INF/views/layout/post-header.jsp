            ...
            <div style="margin-bottom: 70px">
                ...
                <nav class="navbar navbar-expand-sm my_navbar">
                    ...
                    <div class="my_navbar_title">
                        <a href="/post/listForm/${categoryList[0].userId}" style="color: black">${user.nickname} 의 블로그</a>
                    </div>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <div class="dropdown dropleft">
                                <div data-toggle="dropdown">
                                    <img id="profileImg" src="/img/${user.profileImg}" style="width: 80px;height:80px;border-radius: 70%;">
                                    <!-- 사진 사이즈 조절 -->
                                </div>
