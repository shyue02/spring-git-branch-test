        ...
        <div class="container">
            <div class="my_auth_box">
                <div class="my_auth_form_box" style="width: 700px">
                    <div class="my_auth_form_box_title">TSotry</div>
                    ...
                    <div style="display: flex">
                        ...
                        <input id="categoryTitle" oninput="checkCategoryTitle();validCategoryTitle();" class="my_auth_form_box_input" type="text"
