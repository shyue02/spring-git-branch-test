        ...
        <body>
            <div style="height: 120px">
                ...
                <nav id="navbar" class="navbar navbar-expand-sm my_navbar">
                    ...
                    <div class="my_navbar_title">
                        <a class="drawer-brand" href="/">스토리 </a>
                    </div>
                    <!-- 페이지 이동 -->
            ...
            <div class="container-fluid">
                <div class="row flex-nowrap">
                    <div id="sidebar" class="col-3 bd-sidebar" style="background-color: white; color: black">
                            ...
                            <ul class="nav">
                                ...
                                <c:forEach var="subscribe" items="${subscribeList}">
                                    <li style="padding-left: 30px;padding-top: 10px;">
                                        <a href="/post/listForm/${subscribe.usersId}">${subscribe.nickname} 의 블로그</a>
                                    </li>
                                </c:forEach>
                            </ul>
                            <br />
                        ...
                        <div class="bd-sidebar-footer">
                            <a href="/post/listForm/${principal.userId}">내블로그 바로가기</a>
                        </div>
                    </div>
                        ...
                        <c:forEach var="post" items="${postList}">
                            <div class="my_post_list_item">
                                ...
                                <div class="my_post_list_item_right my_ellipsis">
                                    ...
                                    <div class="my_mt_md_1" style="padding-top: 10px">
                                        <a href="/post/detailForm/${post.postId}/${post.userId}">
                                            <button type="button" class="btn btn-light" style="border: 2px solid black" ;line-height: 20px;>
                                                더보기
                                            </button></a>
                                    </div>
                                </div>
